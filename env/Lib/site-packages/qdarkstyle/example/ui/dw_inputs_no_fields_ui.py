...
# Form implementation generated from reading ui file 'c:\novo\env\Lib\site-packages\qdarkstyle\example\ui\dw_inputs_no_fields.ui'
#
...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.dial.sliderMoved['int'].connect(self.dialDis.setValue) # type: ignore
        self.horizontalScrollBar.sliderMoved['int'].connect(self.horizontalScrollBarDis.setValue) # type: ignore
        self.horizontalSlider.sliderMoved['int'].connect(self.horizontalSliderDis.setValue) # type: ignore
        self.verticalScrollBar.sliderMoved['int'].connect(self.verticalScrollBarDis.setValue) # type: ignore
        self.verticalSlider.sliderMoved['int'].connect(self.verticalSliderDis.setValue) # type: ignore
        self.comboBox.currentIndexChanged['int'].connect(self.comboBoxDis.setCurrentIndex) # type: ignore
