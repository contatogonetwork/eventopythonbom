...
# Form implementation generated from reading ui file 'c:\novo\env\Lib\site-packages\qdarkstyle\example\ui\dw_buttons.ui'
#
...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.radioButtonChecked.clicked['bool'].connect(self.radioButtonCheckedDis.setChecked) # type: ignore
        self.radioButtonUnchecked.clicked['bool'].connect(self.radioButtonUncheckedDis.setChecked) # type: ignore
        self.checkBoxChecked.clicked['bool'].connect(self.checkBoxCheckedDis.setChecked) # type: ignore
        self.checkBoxEnabled.clicked['bool'].connect(self.checkBoxUncheckedDis.setChecked) # type: ignore
        self.commandLinkButton.clicked['bool'].connect(self.commandLinkButtonDIs.setChecked) # type: ignore
        self.pushButtonChecked.clicked['bool'].connect(self.pushButtonCheckedDis.setChecked) # type: ignore
        self.pushButtonUnchecked.clicked['bool'].connect(self.pushButtonUncheckedDis.setChecked) # type: ignore
        self.pushButton.clicked['bool'].connect(self.pushButtonDis.click) # type: ignore
