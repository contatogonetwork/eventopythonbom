...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Verificar se o botão de analytics existe antes de conectar
        if hasattr(widgets, "btn_analytics"):
            widgets.btn_analytics.clicked.connect(self.buttonClick)
    ...
    def mousePressEvent(self, event):
        ...
        # PRINT MOUSE EVENTS        if event.buttons() == Qt.LeftButton:
    ...
    def init_windows(self):
        ...
        # Limpar stackedWidget (remover páginas existentes)
